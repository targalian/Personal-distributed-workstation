#!/usr/bin/env bash
# start_station.sh - 启动 LAN Mesh Station Director
# 用法: bash scripts/start_station.sh [--port 8080] [--name "控制中心"]
...
# 构建启动命令
CMD=($PYTHON main.py station --port "$PORT")
...
echo " Secretary: 未激活 (请在 Web UI 中激活)"
echo "========================================"
echo ""
