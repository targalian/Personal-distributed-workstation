...
MAPPING = {
    ...
    "AGENT_LOCKS.md": ("10-test-loop", "多 Agent 占用登记与交接看板 (根目录)"),
    ".githooks/": ("10-test-loop", "commit-msg / pre-push / post-merge / post-commit 钩子"),
    ...
    "scripts/boss_channel.py": "11-scripts-subprojects",
    "scripts/fix_task_project_binding.py": "11-scripts-subprojects",
    ...
    ".qoder/skills/": ("11-scripts-subprojects",
                      "Qoder 技能库 (docs-sync / code-review / repowiki-update 等)"),
