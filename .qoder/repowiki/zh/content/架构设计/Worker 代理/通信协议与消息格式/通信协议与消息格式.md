...
subgraph "Master"
M["station_controller.py<br/>注册/心跳/状态聚合/Web UI"]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L67-L144)
...
- [station_controller.py](file://lan_mesh/station_controller.py#L160-L184)
...
Master["station_controller.py"] --> Protocol
Master --> Discovery
Master --> HostInfo
Master --> APIM["api.py"]
Master --> Config
