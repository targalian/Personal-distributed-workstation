...
subgraph "角色服务"
MASTER["station_controller.py<br/>Station Director"]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L152-L164)
...
REQ --> PD["pydantic"]
MASTER["station_controller.py"] --> API["api.py"]
