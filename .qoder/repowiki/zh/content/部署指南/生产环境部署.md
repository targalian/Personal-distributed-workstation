...
subgraph "业务逻辑层"
Master[station_controller.py<br/>StationDirector]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L257-L269)
...
- [station_controller.py](file://lan_mesh/station_controller.py#L27-L44)
- [lan_mesh/worker.py:24-44](file://lan_mesh/worker.py#L24-L44)

**章节来源**
- [requirements.txt:1-8](file://requirements.txt#L1-L8)
- [station_controller.py](file://lan_mesh/station_controller.py#L17-L44)
