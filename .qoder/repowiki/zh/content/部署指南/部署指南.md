...
- [lan_mesh/pm_agent.py](file://lan_mesh/pm_agent.py)
...
- 新增 Work Station 一键启动脚本（start_workstation.bat、start_workstation.ps1）
- 新增 PM Agent 架构的部署要求和管理功能
- 新增完整的 Web UI 仪表盘和 Dashboard 界面
- 新增 Secretary 模式的动态激活/停用机制
- 新增 Station Director 的基础设施管理功能
- 更新模型池配置系统的完整说明，包含订阅制模型支持
- **新增 Windows 启动脚本国际化改进**：统一设置 UTF-8 编码支持，确保中文显示正常
...
**更新** 新增跨平台启动脚本支持，提供完整的 Work Station 一键启动方案，包含 PM Agent 架构部署要求和动态 Secretary 激活功能。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持，确保中文显示正常。
...
**更新** 新增 PM Agent 架构的完整功能分析，包括团队管理、进度跟踪和子 Agent 协作机制，以及 Work Station 一键启动脚本的支持。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 架构的完整功能分析，包括基础设施管理、动态 Secretary 激活和 Web UI 仪表盘。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 架构的集成，提供任务编排和预算控制功能，支持阿里云百炼 Token Plan 模型。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增阿里云百炼 Token Plan 配置支持，提供完整的订阅制模型接入方案，包含多品牌模型统一 Credits 计量。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 架构的完整分析，包括团队管理、进度跟踪和子 Agent 协作机制。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 相关的性能考虑，包括团队管理查询和进度报告的性能优化。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 相关的故障排查，包括 PM Agent 创建、团队管理和进度报告的问题诊断。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
## 结论
Work Station 项目提供了清晰的 Station Director + Secretary/Worker 架构与完善的局域网发现、注册、心跳与可视化能力。通过合理的网络规划、容器化与高可用部署，可在生产环境中稳定运行。新增的 PM Agent 架构进一步增强了项目的团队管理和任务协作能力。建议结合本文的部署步骤、性能调优与安全加固建议，逐步完成上线与运维。
...
**更新** 新增 Windows 批处理脚本的完整使用说明，提供一键式环境初始化体验。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 ALIYUN_TOKENPLAN_API_KEY 环境变量设置说明，支持阿里云百炼 Token Plan 配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
3. 安装依赖
4. 复制配置文件
5. 启动 Station Director
6. 可选：后台启动本地 Worker

**更新** 新增 Work Station 一键启动脚本的完整使用说明，包含参数传递和自定义配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增完整的跨平台启动脚本使用说明，包括参数传递和自定义配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增完整的 Windows 批处理脚本使用说明，包括参数传递和自定义配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 Windows 批处理脚本的 Worker 启动说明。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增命令行参数覆盖配置的高级部署选项。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增阿里云百炼 Token Plan 配置文件的容器化部署注意事项，包括环境变量注入和 Token Plan 服务的网络访问配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增阿里云百炼 Token Plan 配置文件的 Kubernetes 部署配置，包括 Secret 管理和环境变量注入。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增模型路由器在高可用场景下的部署考虑，包括 Token Plan 服务的高可用配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
- Windows：Python 与端口占用检查；注意 PowerShell 执行策略与防病毒软件拦截。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
- macOS：网络接口命名差异；注意系统权限与防火墙设置。
- 前端桌面应用（QuickLAN）：Windows 安装包生成路径与端口范围参考 README。

**更新** 新增 Windows 批处理脚本的执行策略和防病毒软件注意事项。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增模型路由器和 PM Agent 的性能调优建议，包括加权评分算法的计算优化和降级链的容错机制。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增模型路由器和 PM Agent 的监控指标建议，包括 Token Plan 服务的使用情况监控。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增模型池配置文件和 PM Agent 数据的备份和恢复策略，包括 Token Plan 配置的安全存储建议。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增模型池配置文件和 PM Agent 数据的安全存储和访问控制建议，包括 Token Plan API Key 的安全管理。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增端口说明表格，包含模型路由器和项目管理器的 API 端口。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 PM Agent 管理的 API 端点说明。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
**更新** 新增 Work Station 一键启动脚本的完整使用说明，包括环境初始化和参数传递。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
- [scripts/start_workstation.ps1:1-144](file://scripts/start_workstation.ps1#L1-L144)
...
- **新增** 字符编码：**Windows 启动脚本已统一设置 UTF-8 编码支持**，确保中文显示正常。所有批处理脚本均包含 `chcp 65001 >nul 2>&1` 命令来设置 UTF-8 编码，`set PYTHONIOENCODING=utf-8` 和 `set PYTHONUTF8=1` 环境变量来确保 Python 输出编码正确。

**更新** 新增 Windows 平台特有的部署注意事项和解决方案，包括 UTF-8 编码支持的详细说明。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
#### 脚本功能概述
Work Station 一键启动脚本（start_workstation.bat、start_workstation.ps1）提供了一键式部署体验，自动完成环境检查、依赖安装、配置复制和启动流程。
...
4. **配置复制**：复制模型池配置模板
5. **启动服务**：启动 Station Director（默认端口 45470）
6. **可选 Worker**：支持后台启动本地 Worker 节点
...
**更新** 新增 Work Station 一键启动脚本的完整使用说明，包括参数传递和自定义配置。**新增 Windows 启动脚本国际化改进**，统一设置 UTF-8 编码支持。
...
- 订阅制服务按 Credits 讧量，无需显式设置每千tokens成本
...
#### UTF-8 编码支持
所有 Windows 启动脚本均已统一设置 UTF-8 编码支持，确保中文显示正常：
...
**更新** 新增 Windows 启动脚本国际化改进的详细说明，包括 UTF-8 编码支持的具体实现和改进效果。
