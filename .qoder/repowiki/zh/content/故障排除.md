...
- 相关实现：
  ...
  - 端口占用与自动递增：[Master._find_available_port:225-234](file://lan_mesh/station_controller.py#L225-L234)、[Worker._find_available_port:240-249](file://lan_mesh/worker.py#L240-L249)
...
**章节来源**
- [station_controller.py](file://lan_mesh/station_controller.py#L319-L324)
