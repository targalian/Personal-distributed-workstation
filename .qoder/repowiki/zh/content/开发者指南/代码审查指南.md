...
A --> C["StationDirector<br/>station_controller.py"]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L69-L129)
...
SEC["StationDirector<br/>station_controller.py"]
...
### Secretary Controller（station_controller.py）
...
- [station_controller.py](file://lan_mesh/station_controller.py#L202-L240)
- [station_controller.py](file://lan_mesh/station_controller.py#L190-L199)

章节来源
- [station_controller.py](file://lan_mesh/station_controller.py#L69-L129)
- [station_controller.py](file://lan_mesh/station_controller.py#L130-L189)
...
DB --> SECRETARY["station_controller.py"]
DB --> WORKER["worker.py"]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L255-L263)
