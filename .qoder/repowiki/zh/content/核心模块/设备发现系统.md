...
subgraph "应用层"
J[station_controller.py<br/>Station Director]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L1-L50)
...
**图表来源**
- [station_controller.py](file://lan_mesh/station_controller.py#L68-L342)
...
**图表来源**
- [station_controller.py](file://lan_mesh/station_controller.py#L56-L121)
...
J[config.py<br/>配置管理]
K[api.py<br/>API 路由]
L[station_controller.py<br/>Station Director]
...
- [station_controller.py](file://lan_mesh/station_controller.py#L32-L46)
