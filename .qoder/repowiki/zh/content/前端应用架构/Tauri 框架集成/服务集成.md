...
graph TB
subgraph "Python 后端"
M["StationDirector<br/>station_controller.py"]
...
participant MC as "StationDirector<br/>station_controller.py"
...
图表来源
- [station_controller.py](file://lan_mesh/station_controller.py#L77-L113)
